...
class App {
  ...
  createViewer () {
    ...
    this.viewerEl_1 = document.createElement('div');
    this.viewerEl_1.classList.add('viewer_1');
    this.dropEl.innerHTML = '';
    this.dropEl.appendChild(this.viewerEl);
    this.dropEl.appendChild(this.viewerEl_1);
    this.viewer = new Viewer(this.viewerEl, this.options);
    this.viewer_1 = new Viewer(this.viewerEl_1, this.options);
  ...
  view (rootFile, rootPath, fileMap) {
    ...
    const viewer_1 = this.viewer_1 || this.createViewer();
